...
public class SwiftOpenidconnectPlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "openidconnect", binaryMessenger: registrar.messenger())
    let instance = SwiftOpenidconnectPlugin()
